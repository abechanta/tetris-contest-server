...
/**
 * Servlet implementation class QueryHistory_Histogram
 */
@WebServlet("/QueryHistory_Histogram")
public class QueryHistory_Histogram extends DbHttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String encoding = "utf-8";
	private static final String fwdUrl = "histogram.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			outArray = ScoreForStats.queryHistory(conn, mid0, ruleid0, date0tmp, date1tmp, category0);
		} catch (Exception ex) {
			ex.printStackTrace();
			throw new ServletException(ex.getMessage());
		}
